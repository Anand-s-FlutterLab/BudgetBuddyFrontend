        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Form(
                key: addProvider.incomeExpenseFormKey,
                child: Padding(
                  padding:
                  ...
                  child: Column(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          if (addProvider.incomeExpenseFormKey.currentState!
                              .validate()) {
                            int currentIncome = 0;
                            int currentExpense = 0;
                            if (!homeProvider.isMonthlyBudgetEmpty) {
                              currentIncome = homeProvider.monthlyBudget
                                      .months[addProvider.entryMonth]?.income ??
                                  0;
                              currentExpense = homeProvider
                                      .monthlyBudget
                                      .months[addProvider.entryMonth]
                                      ?.expense ??
                                  0;
                            }

                            int amount =
                                int.parse(addProvider.amountController.text);
